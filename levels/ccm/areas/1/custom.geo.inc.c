...
const GeoLayout Geo_ccm_1_0x16d6de0[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom23796896_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_ccm_1_0xe0d95d0),
GEO_DISPLAY_LIST(4,DL_ccm_1_0xe106f68),
GEO_DISPLAY_LIST(5,DL_ccm_1_0xe110a48),
GEO_RENDER_OBJ(),
