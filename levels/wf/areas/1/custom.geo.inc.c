...
const GeoLayout Geo_wf_1_0x14a4430[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom21492464_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_wf_1_0xe0b5a10),
GEO_DISPLAY_LIST(4,DL_wf_1_0xe0e2970),
GEO_DISPLAY_LIST(5,DL_wf_1_0xe0e5500),
GEO_RENDER_OBJ(),
