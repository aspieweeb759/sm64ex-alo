...
const GeoLayout Geo_wf_1_0x136a590[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom20203104_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_wf_1_0xe032b30),
GEO_DISPLAY_LIST(5,DL_wf_1_0xe03c9e8),
GEO_RENDER_OBJ(),
