...
const GeoLayout Geo_bitdw_1_0x1c36460[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom29430560_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bitdw_1_0xe064ce0),
GEO_DISPLAY_LIST(4,DL_bitdw_1_0xe079ec8),
GEO_DISPLAY_LIST(5,DL_bitdw_1_0xe07e0a8),
GEO_RENDER_OBJ(),
