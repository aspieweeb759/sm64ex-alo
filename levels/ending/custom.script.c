...
AREA(1,Geo_ending_1_0x1253a60),
TERRAIN(col_ending_1_0xe0018b0),
...
OBJECT_WITH_ACTS(0,-109,0,-102,0,-90,0,0xa0000, bhvSpinAirborneWarp,31),
OBJECT_WITH_ACTS(221,-1417,0,746,0,0,0,0x85000000, bhvToadMessage,31),
OBJECT_WITH_ACTS(124,-3297,726,-141,0,90,0,0x310000, bhvMessagePanel,31),
RETURN()
};
