...
const GeoLayout Geo_hmc_2_0x1872560[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom25481792_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_hmc_2_0xe083fb0),
GEO_DISPLAY_LIST(4,DL_hmc_2_0xe0a1db0),
GEO_DISPLAY_LIST(5,DL_hmc_2_0xe0a5c50),
GEO_RENDER_OBJ(),
