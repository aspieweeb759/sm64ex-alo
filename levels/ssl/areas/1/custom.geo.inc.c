...
const GeoLayout Geo_ssl_1_0x1952850[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom26400528_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_ssl_1_0xe077f10),
GEO_DISPLAY_LIST(4,DL_ssl_1_0xe08ce98),
GEO_DISPLAY_LIST(5,DL_ssl_1_0xe08d980),
GEO_RENDER_OBJ(),
