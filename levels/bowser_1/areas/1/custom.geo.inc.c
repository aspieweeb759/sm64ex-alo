...
const GeoLayout Geo_bowser_1_1_0x1cc3c00[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom30010048_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bowser_1_1_0xe019ca0),
GEO_DISPLAY_LIST(4,DL_bowser_1_1_0xe01dc48),
GEO_RENDER_OBJ(),
