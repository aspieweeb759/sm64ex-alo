...
AREA(1,Geo_bowser_2_1_0x1cda490),
TERRAIN(col_bowser_2_1_0xe00b1c0),
...
OBJECT_WITH_ACTS(0,155,889,34,0,0,0,0xa0a0000, bhvSpinAirborneCircleWarp,31),
OBJECT_WITH_ACTS(0,-1729,1424,16,0,173,0,0x0, bhvKingBobomb,31),
OBJECT_WITH_ACTS(87,-1234,369,-45,0,0,0,0x0, bhvBigBully,31),
OBJECT_WITH_ACTS(180,4426,-3759,-10867,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,2902,-7408,-9915,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(0,4481,-3460,-6454,0,0,0,0x0, bhvCoinFormation,31),
OBJECT_WITH_ACTS(137,4355,-5198,-9887,0,0,0,0x40000, bhvFlamethrower,31),
OBJECT_WITH_ACTS(58,146,0,-775,0,0,0,0x0, bhvLllRotatingBlockWithFireBars,31),
OBJECT_WITH_ACTS(58,81,0,958,0,0,0,0x0, bhvLllRotatingBlockWithFireBars,31),
OBJECT_WITH_ACTS(0,4647,-1360,-95,0,0,0,0x0, bhvGoombaTripletSpawner,31),
OBJECT_WITH_ACTS(180,2964,-911,-206,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(137,4361,-5198,-9889,0,0,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(137,4361,-5198,-9889,0,90,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(137,4361,-5198,-9889,0,180,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(137,4361,-5198,-9889,0,270,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(180,4391,-7408,-8906,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,4523,-7408,-10883,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,5682,-7408,-9695,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,3185,-3759,-8886,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,5684,-3759,-8897,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(0,3201,-3759,-9830,0,0,0,0x0, bhvMrI,31),
OBJECT_WITH_ACTS(0,5669,-3759,-9892,0,0,0,0x0, bhvMrI,31),
OBJECT_WITH_ACTS(0,12,5,4,0,0,20,26, RM_Scroll_Texture,31),
RETURN()
};
const LevelScript local_warps_bowser_2_1_[] = {
WARP_NODE(10,9,1,0,0),
WARP_NODE(240,19,1,5,0),
WARP_NODE(241,19,3,61,0),
RETURN()
};
