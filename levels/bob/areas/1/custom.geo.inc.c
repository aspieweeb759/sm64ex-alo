...
const GeoLayout Geo_bob_1_0x136be30[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom20212976_skybox_Index+10, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bob_1_0xe09d8a0),
GEO_DISPLAY_LIST(4,DL_bob_1_0xe0c0c50),
GEO_DISPLAY_LIST(5,DL_bob_1_0xe0c3d40),
GEO_RENDER_OBJ(),
