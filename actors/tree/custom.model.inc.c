...
Vtx VB_spiky_tree_geo_0x3032048[] = {
{{{ 128, 512, 0 }, 0, { 990, 0 }, { 0, 0, 127, 255}}},
{{{ -127, 512, 0 }, 0, { 0, 0 }, { 0, 0, 127, 255}}},
{{{ -127, 0, 0 }, 0, { 0, 2012 }, { 0, 0, 127, 255}}},
{{{ 128, 0, 0 }, 0, { 990, 2012 }, { 0, 0, 127, 255}}},
...
Vtx VB_spiky_tree_geo_0x3033218[] = {
...
Light_t Light_snow_tree_geo_0x302de18 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_snow_tree_geo_0x302de10 = {
{63, 63, 63}, 0, {63, 63, 63}, 0
};

Gfx DL_snow_tree_geo_0x3032088[] = {
gsDPPipeSync(),
...
gsSPLight(&Light_snow_tree_geo_0x302de18.col, 1),
gsSPLight(&Light_snow_tree_geo_0x302de10.col, 2),
...
Gfx DL_palm_tree_geo_0x3033258[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
gsSPGeometryMode(G_SHADING_SMOOTH, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
Gfx DL_bubbly_tree_geo_0x302fee8[] = {
gsDPPipeSync(),
...
Gfx DL_bubbly_tree_geo_0x302fe88[] = {
...
Gfx DL_bubbly_tree_geo_0x302feb8[] = {
...
Gfx DL_spiky_tree_geo_0x3030fa0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
gsSPGeometryMode(G_SHADING_SMOOTH, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
