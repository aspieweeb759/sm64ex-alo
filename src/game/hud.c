...
void render_hud_coins(void) {
    print_text(HUD_COINS_X, HUD_COINS_Y, "+"); // 'Coin' glyph
    print_text(HUD_COINS_CROSS_X, HUD_COINS_CROSS_Y, "*"); // 'X' glyph
    print_text_fmt_int(HUD_COINS_NUM_X, HUD_COINS_NUM_Y, "%d", gHudDisplay.coins);
}
...
void render_hud_timer(void) {
    ...
    render_hud_tex_lut(HUD_TIME_MIN_A_X, HUD_TIME_A_Y, (*hudLUT)[GLYPH_APOSTROPHE]);
    render_hud_tex_lut(HUD_TIME_SEC_AA_X, HUD_TIME_A_Y, (*hudLUT)[GLYPH_DOUBLE_QUOTE]);
