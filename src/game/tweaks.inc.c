...
#define KING_BOMB_FVEL 8.5f
#define KING_BOMB_YAWVEL 420
#define KING_BOMB_HEALTH 4
#define KING_WHOMP_HEALTH 4
...
#define HUD_STARS_Y 189
#define HUD_STARS_CROSS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(282)
#define HUD_STARS_CROSS_Y 189
#define HUD_STARS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(278)
#define HUD_STARS_NUM_Y 189
