...
#define REDS_REQ 6
#define EXIT_COURSE 2208, 0, 0
#define FALL_DAMAGE 0
...
#define HUD_TIME_MIN_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(191)
#define HUD_TIME_MIN_A_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(-75)
#define HUD_TIME_SEC_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(171)
#define HUD_TIME_SEC_AA_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(146)
#define HUD_TIME_FSEC_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(137)
#define HUD_TIME_A_Y 7
#define POWER_X 140
#define POWER_Y 166
