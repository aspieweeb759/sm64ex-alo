...
#define HUD_LIVES_MARIO_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(253)
#define HUD_LIVES_MARIO_Y 209
#define HUD_LIVES_CROSS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(269)
#define HUD_LIVES_CROSS_Y 209
#define HUD_LIVES_NUM_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(284)
#define HUD_LIVES_NUM_Y 209
#define HUD_COINS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(10)
#define HUD_COINS_Y 188
#define HUD_COINS_CROSS_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(26)
#define HUD_COINS_CROSS_Y 188
#define HUD_COINS_NUM_X GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(41)
#define HUD_COINS_NUM_Y 188
#define HUD_STARS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(310)
#define HUD_STARS_Y 209
#define HUD_STARS_CROSS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(294)
#define HUD_STARS_CROSS_Y 209
#define HUD_STARS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(293)
#define HUD_STARS_NUM_Y 209
#define HUD_TIME_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150)
#define HUD_TIME_Y 185
#define HUD_TIME_MIN_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(78)
#define HUD_TIME_MIN_A_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(33)
#define HUD_TIME_SEC_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(58)
#define HUD_TIME_SEC_AA_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(46)
#define HUD_TIME_FSEC_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(24)
#define HUD_TIME_A_Y 35
#define POWER_X 140
#define POWER_Y 166
