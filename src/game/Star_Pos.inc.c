...
#define KingBobOmbStarPos -145.0f, 8138.0f, 752.0f
#define KingWhompStarPos -1259.0f, -8757.0f, 337.0f
#define EyerockStarPos 0.0f, -900.0f, -3700.0f
#define BigBullyStarPos 421.0f, 4215.0f, -2993.0f
...
#define WigglerStarPos 260.0f, -976.0f, 8.0f
