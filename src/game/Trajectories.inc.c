...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0,-3825,-1651,11065),
	TRAJECTORY_POS(1,-2886,-1651,11331),
	TRAJECTORY_POS(2,-2082,-1651,10377),
	TRAJECTORY_POS(3,-2092,-1651,8007),
	TRAJECTORY_POS(4,-1106,-1651,4370),
	TRAJECTORY_POS(5,-164,-1651,1357),
	TRAJECTORY_POS(6,4169,-1651,1295),
	TRAJECTORY_POS(7,6349,-1651,1050),
	TRAJECTORY_POS(8,6542,-89,4469),
	TRAJECTORY_POS(9,5768,-89,4481),
	TRAJECTORY_POS(10,5437,-89,2370),
	TRAJECTORY_POS(11,5170,-89,1619),
	TRAJECTORY_POS(12,5140,-89,-809),
	TRAJECTORY_POS(13,5140,-89,-2938),
	TRAJECTORY_POS(14,5299,1153,-4811),
	TRAJECTORY_POS(15,6607,-692,-9757),
	TRAJECTORY_END(),
};
...
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0,37,-1603,-6700),
	TRAJECTORY_POS(1,37,-1603,-8222),
	TRAJECTORY_POS(2,3010,-1536,-8222),
	TRAJECTORY_POS(3,3010,-1536,-4900),
	TRAJECTORY_POS(4,2410,-1536,-2863),
	TRAJECTORY_END(),
};
