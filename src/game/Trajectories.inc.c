...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0,-9189,-2410,-3358),
	TRAJECTORY_POS(1,-9189,-2410,-3370),
	TRAJECTORY_POS(2,-13471,-2009,2159),
	TRAJECTORY_POS(3,-9641,-210,6360),
	TRAJECTORY_POS(4,-10615,190,12006),
	TRAJECTORY_POS(5,-3617,190,12025),
	TRAJECTORY_POS(6,-3070,-809,8064),
	TRAJECTORY_POS(7,3283,-2009,6803),
	TRAJECTORY_POS(8,6281,-2410,-2138),
	TRAJECTORY_POS(9,7393,-2410,-7886),
	TRAJECTORY_POS(10,2729,-2410,-8033),
	TRAJECTORY_POS(11,-1183,-2410,-3500),
	TRAJECTORY_END(),
};
const Trajectory KoopaTHI_path[] = {
	TRAJECTORY_POS(0,-8242,-2410,-3505),
	TRAJECTORY_POS(1,-9994,-2410,-2613),
	TRAJECTORY_POS(2,-13027,-2009,2326),
	TRAJECTORY_POS(3,-9689,-210,6711),
	TRAJECTORY_POS(4,-10728,190,12045),
	TRAJECTORY_POS(5,-4202,190,12022),
	TRAJECTORY_POS(6,-182,-2009,7910),
	TRAJECTORY_POS(7,1326,-1965,5176),
	TRAJECTORY_POS(8,3480,-2009,5607),
	TRAJECTORY_POS(9,7659,-2410,-4484),
	TRAJECTORY_POS(10,4593,-2410,-9005),
	TRAJECTORY_POS(11,-1427,-2410,-3255),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0,3250,-3271,-4900),
	TRAJECTORY_POS(1,3250,-777,-4900),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702ECC0_RM2C_path[] = {
	TRAJECTORY_POS(0,-8448,-6434,11499),
	TRAJECTORY_POS(1,-10222,-7059,11436),
	TRAJECTORY_POS(2,-12694,-7059,11436),
	TRAJECTORY_POS(3,-16485,-5711,16726),
	TRAJECTORY_END(),
};
