...
const Trajectory KoopaTHI_path[] = {
	TRAJECTORY_POS(0,-8876,-269,1011),
	TRAJECTORY_POS(1,-8870,-269,1000),
	TRAJECTORY_POS(2,-6408,-269,726),
	TRAJECTORY_POS(3,-6252,-269,-11258),
	TRAJECTORY_POS(4,11620,630,-10998),
	TRAJECTORY_POS(5,11466,630,5195),
	TRAJECTORY_POS(6,-5300,-269,5391),
	TRAJECTORY_POS(7,-4771,-269,12439),
	TRAJECTORY_POS(8,-11852,-269,11964),
	TRAJECTORY_POS(9,-11864,-269,15334),
	TRAJECTORY_END(),
};
