...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0,4534,-280,2789),
	TRAJECTORY_POS(1,2488,665,2726),
	TRAJECTORY_POS(2,1707,3839,-104),
	TRAJECTORY_END(),
};
const Trajectory KoopaTHI_path[] = {
	TRAJECTORY_POS(0,228,-1393,-1756),
	TRAJECTORY_POS(1,2903,-1393,-797),
	TRAJECTORY_POS(2,2108,950,239),
	TRAJECTORY_POS(3,1508,2854,837),
	TRAJECTORY_POS(4,1032,2854,2422),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0,1476,-1576,-3043),
	TRAJECTORY_POS(1,2921,-1094,-3185),
	TRAJECTORY_POS(2,2461,0,-5616),
	TRAJECTORY_POS(3,-1402,0,-5625),
	TRAJECTORY_POS(4,-2402,1458,-6269),
	TRAJECTORY_POS(5,-1115,3229,-6753),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702ECC0_RM2C_path[] = {
	TRAJECTORY_POS(0,-1115,3229,-6753),
	TRAJECTORY_POS(1,-301,3727,7924),
	TRAJECTORY_END(),
};
const Trajectory ccm_seg7_trajectory_0701669C_RM2C_path[] = {
	TRAJECTORY_POS(0,58,1802,4904),
	TRAJECTORY_POS(1,-258,3580,2983),
	TRAJECTORY_END(),
};
...
const Trajectory hmc_seg7_trajectory_0702B86C_RM2C_path[] = {
	TRAJECTORY_POS(0,-2155,-875,-3932),
	TRAJECTORY_POS(1,8675,-875,-7129),
	TRAJECTORY_END(),
};
