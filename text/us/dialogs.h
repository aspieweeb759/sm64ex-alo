DEFINE_DIALOG(DIALOG_000,1,6,30,200, _("Welcome to Rogueport!\n\
Here, all of the\n\
stars are obtainable\n\
without the wing\n\
cap, but some are\n\
significantly more\n\
difficult to get\n\
...
DEFINE_DIALOG(DIALOG_001,1,4,95,200, _("Congratulations!\n\
You've made it to\n\
the dangerous and\n\
terrifying Hooktail's\n\
Castle! Here's a hint\n\
that may help you out:\n\
Only two of the stars\n\
are obtained outdoors.\n\
Good luck!"))

DEFINE_DIALOG(DIALOG_002,1,4,95,200, _("Welcome to the town of\n\
perpetual twilight,\n\
Twilight Town (as you\n\
may have guessed).\n\
There are rumors that\n\
two of the Crystal\n\
Star shards appear in\n\
a locked room that\n\
requires the Metal Cap\n\
switch to open. Have\n\
you found it yet?\n\
Don't let the endless\n\
twilight drive you to\n\
madness!"))
...
DEFINE_DIALOG(DIALOG_008,1,4,30,200, _("Welcome to the Boggly\n\
Woods! Although they\n\
probably aren't exactly\n\
as you remember.\n\
Keep in mind that the\n\
course is divided\n\
basically into two L\n\
shaped sections, an\n\
inner one and an outer\n\
one. The components for\n\
star 3 are in the inner\n\
one, and the components\n\
for star 4 are on the\n\
outer one (with maybe\n\
an exception). Also,\n\
you can't jump over\n\
the black bushes from\n\
this side. Have fun!"))
...
DEFINE_DIALOG(DIALOG_013,1,5,30,200, _("You've collected 80\n\
coins! Mario got another\n\
chapter star!\n\
Do you want to Save?\n\
//Yes////No"))
...
from the chapter stars!\n\
\n\
Do you want to Save?\n\
\n\
//You Bet//Not Now"))

DEFINE_DIALOG(DIALOG_015,1,4,30,200, _("PIPE WARPS\n\
-The warp behind and to\n\
the left will take one\n\
back to the top of the\n\
ramp.\n\
-The warp in your front\n\
to the left will take\n\
you to The Solitary Tree.\n\
-The warp in your front\n\
to the right will take\n\
you towards The Great\n\
Tree and Madame Flurrie's."))

DEFINE_DIALOG(DIALOG_016,1,3,30,200, _("Before you is the Great\n\
Tree, in all its glory!\n\
Just remember that once\n\
you enter it, you'll\n\
lose any coins and such\n\
from this level. Have\n\
fun!"))

DEFINE_DIALOG(DIALOG_017,1,4,30,200, _("Mario?! How did\n\
you find me here?!\n\
I came all the way\n\
to the top of this\n\
castle to have some\n\
...
DEFINE_DIALOG(DIALOG_018,1,4,30,200, _("Welcome to Petal Meadows!\n\
It's full of wonder,\n\
excitement, and...petals.\n\
And what is that in the\n\
distance? Hooktail's\n\
Castle? I wonder if it's\n\
anything like it used to\n\
be...can you even reach\n\
it yet? Might have to\n\
get a star or two in\n\
the meadows first!"))

DEFINE_DIALOG(DIALOG_019,1,2,30,200, _("Whoa...Hooktail's\n\
Castle! Ready yourself\n\
to face the music!\n\
But first, make sure\n\
you are ready to forfeit\n\
any progress on your\n\
current star in the\n\
meadows, as the Castle\n\
is it's own course!"))
...
DEFINE_DIALOG(DIALOG_030,1,6,30,200, _("Welcome to the town of\n\
perpetual twilight,\n\
Twilight Town (as you\n\
may have guessed).\n\
There are rumors that\n\
...
DEFINE_DIALOG(DIALOG_032,1,5,30,200, _("If you get the Wing Cap,\n\
...
DEFINE_DIALOG(DIALOG_036,1,5,30,200, _("OBSERVATION PLATFORM\n\
...
DEFINE_DIALOG(DIALOG_039,1,4,30,200, _("No visitors allowed,\n\
by decree of\n\
the Big Bob-omb\n\
\n\
...
DEFINE_DIALOG(DIALOG_042,1,4,30,200, _("Oh no! What's happened\n\
to the sky?! It seems\n\
as though Flurrie's\n\
house has been\n\
transported to another\n\
dimension! Ah well,\n\
getting a star should\n\
take you back to your\n\
own universe. Onward\n\
then!"))

DEFINE_DIALOG(DIALOG_043,1,5,30,200, _("YOUUUUU SHALL NOT\n\
PAAAAAAASSSS!!!!!!!\n\
-Sign"))

DEFINE_DIALOG(DIALOG_044,1,5,95,200, _("Due to the laziness\n\
of----I mean abnormal\n\
growth of the Great\n\
Tree, the doorways\n\
in this room turned\n\
...
DEFINE_DIALOG(DIALOG_045,1,6,95,200, _("WARNING: Do not go\n\
through this door\n\
until the ★ tells\n\
you what to do\n\
first, or you shall\n\
...
DEFINE_DIALOG(DIALOG_060,1,4,30,200, _("Thousand-Year Door 64\n\
Levels and Design by\n\
FrozenEternalToaster aka\n\
ToasterKetchup.\n\
Fonts, logo, playtests, \n\
objects placement by\n\
aglab2.\n\
Good luck!"))

DEFINE_DIALOG(DIALOG_061,1,4,30,200, _("Entering this warp will\n\
cause make you lose\n\
all your coins in current\n\
level!"))

DEFINE_DIALOG(DIALOG_062,1,3,30,200, _("In order to complete\n\
this course you will\n\
need to find Vanish Cap\n\
If you still do not have it,\n\
look it up in Chapter 3,\n\
house on the right."))

DEFINE_DIALOG(DIALOG_063,1,5,30,200, _("This course was cut from\n\
the final game because\n\
it was way too bad.\n\
But as you get here, I\n\
will leave it as a bonus.\n\
All stars in this course\n\
are fake."))

DEFINE_DIALOG(DIALOG_064,1,5,30,200, _("If you want to find the\n\
way on top of the blimp,\n\
try flying in the coin!\n\
Betcha there is a warp\n\
out there."))

DEFINE_DIALOG(DIALOG_065,1,3,30,200, _("Please use shells to\n\
traverse the ocean!\n\
...
DEFINE_DIALOG(DIALOG_067,1,5,30,200, _("Managed to finally get\n\
to me? Try to collect\n\
all my secrets here and\n\
try not to die!\n\
Bwahahaha!"))
...
DEFINE_DIALOG(DIALOG_116,1,5,95,200, _("Ouch, that smarts!!!\n\
How many times have\n\
you beaten me now?\n\
50 gazillion?!? I\n\
