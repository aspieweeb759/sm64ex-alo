DEFINE_DIALOG(DIALOG_000,1,3,30,200, _("Mario, you're alive! They\n\
must have thrown you\n\
down here too, huh?\n\
No, just me? [Z]Curse my\n\
stubby little stature...[Z]\n\
\n\
The parasite controlling\n\
the other Toads wants\n\
you to burn! It can't\n\
consume your flesh until\n\
you've been roasted but\n\
here's an escape!\n\
Take this pipe and grab\n\
some stars before coming\n\
back to the star door just\n\
outside the arena. You'll\n\
need 20 stars to see past\n\
their thin veil and fight\n\
the true controller of the\n\
parasite. Good luck!"))

DEFINE_DIALOG(DIALOG_001,1,3,95,200, _("Heck yeah we have grass\n\
in hell!\n\
It grew when the creator\n\
put a hot spring up here.\n\
Something about\n\
decreasing fall damage.\n\
Then one day it left and\n\
a tree grew in it's place!"))

DEFINE_DIALOG(DIALOG_002,1,2,95,200, _("That green pipe leads to\n\
a sewer system under\n\
the place you're trying\n\
to go to lol"))

DEFINE_DIALOG(DIALOG_003,1,3,30,200, _("I must find a way to \n\
enter the Event Horizon. \n\
Something terrible must \n\
have happened for such \n\
a huge spacecraft to be \n\
in trouble. The distress \n\
signal I received \n\
sounded like utter chaos. \n\
I can't get Toad's \n\
screams out of my head. \n\
I hope Peach is alright. \n\
Well, no matter what's \n\
in there, it's time to \n\
face the music."))

DEFINE_DIALOG(DIALOG_004,1,3,30,200, _("Just great, I can barely \n\
see anything. Seems like \n\
the ship is in lockdown \n\
mode. If I can find the \n\
control room, maybe I \n\
can get the lights back \n\
on and unlock other \n\
parts of the ship."))

DEFINE_DIALOG(DIALOG_005,1,1,95,200, _("ENGINE ROOM"))

DEFINE_DIALOG(DIALOG_006,1,1,95,200, _("CONTROL ROOM"))

DEFINE_DIALOG(DIALOG_007,1,3,30,200, _("Ah, the control room.\n\
\n\
\n\
There must be a \n\
...
DEFINE_DIALOG(DIALOG_008,1,2,95,200, _("LOCKDOWN OVERRIDE \n\
SWITCH"))

DEFINE_DIALOG(DIALOG_009,1,3,30,200, _("I got the lights on, but \n\
something doesnt feel \n\
right..."))

DEFINE_DIALOG(DIALOG_010,1,3,30,200, _("Would you like to Save?\n\
\n\
//Yes////No"))

DEFINE_DIALOG(DIALOG_011,1,3,30,200, _("Would you like to Save?\n\
\n\
//Yes////No"))

DEFINE_DIALOG(DIALOG_012,1,3,30,200, _("Would you like to Save?\n\
\n\
//Yes////No"))

DEFINE_DIALOG(DIALOG_013,1,3,30,200, _("Something unspeakable \n\
has corrupted the ship.\n\
... \n\
And now the Event \n\
Horizon is in pieces? \n\
...\n\
...
DEFINE_DIALOG(DIALOG_014,1,3,30,200, _("Would you like to Save?\n\
\n\
//Yes////No"))

DEFINE_DIALOG(DIALOG_015,1,3,30,200, _("I must find a way to \n\
enter the Event Horizon. \n\
Something terrible must \n\
have happened for such \n\
a huge spacecraft to be \n\
...
and BenWolf)\n\
(No Fall Damage,\n\
Exit Course take you\n\
to Hub World)"))

DEFINE_DIALOG(DIALOG_016,1,3,30,200, _("Just great, I can barely \n\
see anything. Seems like \n\
the ship is in lockdown \n\
mode. If I can find the \n\
control room, maybe I \n\
...
DEFINE_DIALOG(DIALOG_017,1,2,95,200, _("What is this place?\n\
...
DEFINE_DIALOG(DIALOG_018,1,1,95,200, _("ENGINE ROOM"))

DEFINE_DIALOG(DIALOG_019,1,1,95,200, _("CONTROL ROOM"))

DEFINE_DIALOG(DIALOG_020,1,3,30,200, _("So there was once a \n\
civilization in this \n\
dimension. But the only \n\
beings I've seen here are \n\
the Toads from the \n\
Event Horizon. There \n\
must be someone else\n\
in this place..."))

DEFINE_DIALOG(DIALOG_021,1,2,30,200, _("Can you see us? \n\
\n\
Soon you wont need \n\
eyes to do that."))

DEFINE_DIALOG(DIALOG_022,1,2,30,200, _("This path requires 20\n\
stars."))

DEFINE_DIALOG(DIALOG_023,1,3,30,200, _("What happened to \n\
Peach? She became one \n\
with us.\n\
We are different from \n\
your lifeforms.\n\
\n\
Your kind multiplies \n\
and pushes away. We \n\
only join together."))

DEFINE_DIALOG(DIALOG_024,1,2,30,200, _("Yes, Mario. We are\n\
ready to become one.\n\
But you are not."))

DEFINE_DIALOG(DIALOG_025,1,4,95,200, _("It takes the power of\n\
...
DEFINE_DIALOG(DIALOG_030,1,2,30,200, _("Mario! Thank the stars \n\
you're here...  \n\
But I dont know if I can \n\
make it...\n\
The warp drive on this \n\
ship... experimental...\n\
Something came out of \n\
it...\n\
and pulled the rest of the \n\
crew in...\n\
Peach is in there...\n\
\n\
Mario, you have to save \n\
her and the Toads..."))
...
DEFINE_DIALOG(DIALOG_032,1,3,30,200, _("Ah, the control room.\n\
\n\
\n\
There must be a \n\
manual override switch \n\
...
DEFINE_DIALOG(DIALOG_033,1,6,30,200, _("Ciao! You've reached\n\
...
DEFINE_DIALOG(DIALOG_034,1,6,30,200, _("Good afternoon. The\n\
Lakitu Bros., here,\n\
...
DEFINE_DIALOG(DIALOG_035,1,2,95,200, _("LOCKDOWN OVERRIDE \n\
SWITCH"))

DEFINE_DIALOG(DIALOG_036,1,3,30,200, _("I got the lights on, but \n\
something doesnt feel \n\
right..."))
...
DEFINE_DIALOG(DIALOG_039,1,2,30,200, _("Something unspeakable \n\
has corrupted the ship.\n\
And now the Event \n\
Horizon is in pieces?\n\
...
DEFINE_DIALOG(DIALOG_040,1,2,30,200, _("Mario! Thank the stars \n\
you're here...  \n\
But I dont know if I can \n\
make it...\n\
The warp drive on this \n\
...
DEFINE_DIALOG(DIALOG_042,1,2,30,200, _("I feel like I got turned \n\
inside-out\n\
But theres a Toad!\n\
\n\
Peach must be alive, too!\n\
\n\
YYEEEEOOOOOOOWWWW"))

DEFINE_DIALOG(DIALOG_043,1,3,30,200, _("Peach?\n\
\n\
\n\
Gullible. You're so \n\
gullible, Mario.\n\
...
\n\
Be my guest if you'd like \n\
to try and claw your \n\
way out of here.\n\
We will watch you \n\
suffer."))

DEFINE_DIALOG(DIALOG_044,1,5,95,200, _("Whooo's there? Whooo\n\
...
DEFINE_DIALOG(DIALOG_045,1,6,95,200, _("Whew! I'm just about\n\
...
DEFINE_DIALOG(DIALOG_046,1,2,30,200, _("What is this place?\n\
\n\
Well, this is another\n\
dimension... \n\
or Hell if you prefer.\n\
...
DEFINE_DIALOG(DIALOG_048,1,4,30,200, _("Snow Mountain Summit\n\
Watch for slippery\n\
conditions! Please enter\n\
the cottage first."))

DEFINE_DIALOG(DIALOG_049,1,3,30,200, _("What happened to these \n\
toads? They talk like \n\
theyre possessed. I cant \n\
give up now, I have to \n\
keep moving."))

DEFINE_DIALOG(DIALOG_050,1,3,30,200, _("This dimension was \n\
once not so different \n\
from your home world... \n\
until we took root here. \n\
We absorb everything."))

DEFINE_DIALOG(DIALOG_051,1,3,30,200, _("So there was once a \n\
civilization in this \n\
dimension. \n\
But the only beings Ive \n\
seen here are the Toads \n\
from the Event Horizon. \n\
There must be someone \n\
else in this place..."))

DEFINE_DIALOG(DIALOG_052,1,3,30,200, _("Can you see us? Soon \n\
you wont need eyes to \n\
do that."))

DEFINE_DIALOG(DIALOG_053,1,1,30,200, _("Hello? Anyone here?"))

DEFINE_DIALOG(DIALOG_054,1,2,30,200, _("Im starting to \n\
understand..."))
...
DEFINE_DIALOG(DIALOG_056,1,6,30,200, _("You brrrr-oke my record!\n\
Unbelievable! I knew\n\
...
DEFINE_DIALOG(DIALOG_057,1,4,30,200, _("Egad! My baby!! Have you\n\
seen my baby??? She's\n\
...
DEFINE_DIALOG(DIALOG_058,1,4,30,200, _("You found my precious,\n\
precious baby! Where\n\
...
DEFINE_DIALOG(DIALOG_059,1,4,30,200, _("That's not my baby! She\n\
looks nothing like me!\n\
Her parents must be\n\
worried sick!"))

DEFINE_DIALOG(DIALOG_060,1,2,30,200, _("Theres no death here \n\
anymore. We dont die."))

DEFINE_DIALOG(DIALOG_061,1,3,30,200, _("Sad. These records tell \n\
the stories of millions of generations, \n\
but whoever wrote them \n\
is long gone."))

DEFINE_DIALOG(DIALOG_062,1,2,30,200, _("Nothing is beyond our \n\
reach. \n\
Not time nor space."))

DEFINE_DIALOG(DIALOG_063,1,2,30,200, _("What happened to \n\
Peach? \n\
She became one with us.\n\
\n\
We are different from \n\
your lifeforms.\n\
Your kind multiplies and \n\
pushes away.\n\
We only join together."))

DEFINE_DIALOG(DIALOG_064,1,3,30,200, _("Yes, Mario. \n\
We are ready to \n\
become one.\n\
But you are not. \n\
...
lacking. \n\
\n\
Suffering awaits in the \n\
pit."))

DEFINE_DIALOG(DIALOG_065,1,1,30,200, _("Ugh, what's that smell?"))

DEFINE_DIALOG(DIALOG_066,1,5,30,200, _("Mario, it's Peach!\n\
...
DEFINE_DIALOG(DIALOG_082,1,1,30,200, _("MARIO? \n\
NO!\n\
...
DEFINE_DIALOG(DIALOG_083,1,6,30,200, _("MARIO? \n\
NO!\n\
mistake to come here... \n\
there's no escape... \n\
the crew... \n\
...
DEFINE_DIALOG(DIALOG_093,1,3,30,200, _("Oh course it was me\n\
behind this whole ruse.\n\
There's nobody else who\n\
would be evil enough to\n\
strip the identities away\n\
from every single Toad\n\
across the Mushroom\n\
Kingdom! But alas - you\n\
probably came for a fight.\n\
Have at thee, you pathetic\n\
vile human!"))
...
DEFINE_DIALOG(DIALOG_112,1,4,30,200, _("Collect as many coins as\n\
...
DEFINE_DIALOG(DIALOG_113,1,6,30,200, _("There are special Caps in\n\
...
DEFINE_DIALOG(DIALOG_121,1,3,30,200, _("Whaaaaat?! You actually\n\
defeated me?! This is\n\
unbelievable!\n\
All the work I've done to\n\
cultivate this parasite. I\n\
developed a way to take\n\
control of the Mushroom\n\
Kingdom from the inside\n\
out! Now, all of my work\n\
has crumbled away to\n\
the hands of you, Mario.\n\
Take that star, Mario!\n\
Take it and you'll\n\
succumb to the madness\n\
you've been trying to put\n\
an end to! I dare you.....\n\
....... I dare.... you."))

DEFINE_DIALOG(DIALOG_122,1,4,30,200, _("The Black Hole\n\
Right: Work Elevator\n\
/// Cloudy Maze\n\
Left: Underground Lake"))

DEFINE_DIALOG(DIALOG_123,1,4,30,200, _("Metal Cavern\n\
Right: To Waterfall\n\
Left: Metal Cap Switch"))

DEFINE_DIALOG(DIALOG_124,1,4,30,200, _("Work Elevator\n\
Danger!!\n\
Read instructions\n\
thoroughly!\n\
...
DEFINE_DIALOG(DIALOG_125,1,3,30,200, _("Hazy Maze-Exit\n\
Danger! Closed.\n\
Turn back now."))

DEFINE_DIALOG(DIALOG_126,2,3,30,200, _("Up: Black Hole\n\
Right: Work Elevator\n\
/// Hazy Maze"))

DEFINE_DIALOG(DIALOG_127,3,4,30,200, _("Underground Lake\n\
Right: Metal Cave\n\
Left: Abandoned Mine\n\
///(Closed)\n\
...
DEFINE_DIALOG(DIALOG_138,1,3,30,200, _("Down: Underground Lake\n\
Left: Black Hole\n\
...
DEFINE_DIALOG(DIALOG_141,1,2,30,200, _("Holding this star makes \n\
you feel insightful."))

DEFINE_DIALOG(DIALOG_142,1,2,30,200, _("You can feel your \n\
insight increasing."))

DEFINE_DIALOG(DIALOG_143,1,2,30,200, _("You are starting to \n\
perceive the invisible."))

DEFINE_DIALOG(DIALOG_144,1,1,150,200, _("All the power is yours."))
...
DEFINE_DIALOG(DIALOG_154,1,1,30,200, _("such horrible things..."))
...
DEFINE_DIALOG(DIALOG_167,1,4,30,200, _("Princess Toadstool's\n\
...
DEFINE_DIALOG(DIALOG_169,1,4,30,200, _("Keep out!\n\
That means you!\n\
Arrgghh!\n\
\n\
